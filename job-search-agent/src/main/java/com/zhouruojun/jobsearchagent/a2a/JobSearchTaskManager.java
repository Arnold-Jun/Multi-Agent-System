...
@Slf4j
@Component
public class JobSearchTaskManager extends InMemoryTaskManager {

    private static JobSearchTaskManager INSTANCE;
    ...
    public Mono<? extends JsonRpcResponse<?>> onSendTaskSubscribe(SendTaskStreamingRequest request) {
        ...
        return Mono.fromRunnable(() -> {
            ...
            if (tempTask == null) {
                ...
                // 调用jobSearchControllerCore处理A2A请求（异步）
    ...
    public static void sendTaskUpdateEvent(String taskId, TaskStatus taskStatus, boolean finalFlag) {
        JobSearchTaskManager.INSTANCE.updateTaskAndSendEventAndNotification(taskId, taskStatus, null, finalFlag);
    }
    ...
    public static void sendTextEvent(String requestId, String text, String node) {
        ...
        JobSearchTaskManager.sendTaskUpdateEvent(requestId, taskStatus, "__END__".equals(node) || "__ERROR__".equals(node));
    }
