...
public class A2AController {
    ...
    @Autowired
    private JobSearchAgentCard agentCard;
    ...
    public ResponseEntity<Map<String, Object>> healthCheck() {
        ...
        response.put("service", "job-search-agent");
    ...
    public ResponseEntity<Map<String, Object>> invokeAgent(@RequestBody Map<String, Object> request) {
        try {
            ...
            // 获取用户消息
            String userMessage = (String) parameters.getOrDefault("message", "请帮我分析求职需求");
            
            // 直接调用JobSearchControllerCore进行同步处理
            String result = jobSearchControllerCore.processA2aSync(sessionId, userMessage);
