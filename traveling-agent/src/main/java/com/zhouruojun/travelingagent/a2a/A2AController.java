...
public class A2AController {
    ...
    @Autowired
    private TravelingAgentCard agentCard;
    ...
    public ResponseEntity<Map<String, Object>> healthCheck() {
        ...
        response.put("service", "traveling-agent");
    ...
    public ResponseEntity<Map<String, Object>> invokeAgent(@RequestBody Map<String, Object> request) {
        try {
            ...
            // 获取用户消息
            String userMessage = (String) parameters.getOrDefault("message", "请帮我制定旅游计划");
            
            // 直接调用TravelingControllerCore进行同步处理
            String result = travelingControllerCore.processA2aSync(sessionId, userMessage);
