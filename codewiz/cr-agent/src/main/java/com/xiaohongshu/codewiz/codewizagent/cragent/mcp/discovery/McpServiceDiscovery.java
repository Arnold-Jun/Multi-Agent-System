...
public class McpServiceDiscovery {
    ...
    private McpServiceDiscoveryPollTask mcpServiceDiscoveryPollTask;

    private DiscoveryLoadBalance<Instance> loadBalance;

    private ObjectMapper objectMapper;

    public McpServiceDiscovery(ObjectMapper objectMapper) {
    ...
    public void addServiceName(String serviceName) {
        ...
        mcpServiceDiscoveryPollTask.init(serviceName);
    }
    ...
    public void init() {
        ...
        mcpServiceDiscoveryPollTask = new McpServiceDiscoveryPollTask(this);
        domainThread = new Thread(mcpServiceDiscoveryPollTask);
        domainThread.setDaemon(true);
        domainThread.setName("McpServiceDiscoveryRunnable");
        domainThread.start();
    }
