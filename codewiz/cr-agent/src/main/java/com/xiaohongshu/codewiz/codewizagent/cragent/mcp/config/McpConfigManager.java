package com.xiaohongshu.codewiz.codewizagent.cragent.mcp.config;
...
//        crMcpServer.setUrl("http://127.0.0.1:18082"); // spring-ai
        crMcpServer.setUrl("eds://eemcp-service-default");
        ...
        localMcpServer.setCommand("/tmp/local-mcp-server");
