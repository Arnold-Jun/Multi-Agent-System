...
/**
 * copy by dev.langchain4j.mcp.client.ToolSpecificationHelper
 * 用于tool的转换
 */
public class ToolSpecificationHelper {
    ...
    public static List<ToolSpecification> toolSpecificationListFromMcpResponse(ArrayNode array) {
        ...
        for (JsonNode tool : array) {
            ...
            builder.parameters((JsonObjectSchema) jsonNodeToJsonSchemaElement(tool.get("parameters")));
    ...
    /**
     * Converts the 'parameters' element (inside the 'Tool' type in the MCP schema)
